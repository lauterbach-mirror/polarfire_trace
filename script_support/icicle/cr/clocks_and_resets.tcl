...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_125MHz:INIT_DONE" "INIT_MONITOR_0:DEVICE_INIT_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_CCC_C0_0:REF_CLK_0" "CLKINT_REF_CLK_50MHz:Y" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLKINT_REF_CLK_50MHz:A" "REF_CLK_50MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_125MHz:PLL_POWERDOWN_B" "PF_CCC_C0_0:PLL_POWERDOWN_N_0" }
