...
sd_instantiate_hdl_core -sd_name $sd_name -hdl_core_name axi_to_pti -instance_name axi_to_pti_0
sd_configure_core_instance -sd_name $sd_name -instance_name axi_to_pti_0 -params "gOutBits:$bits_used"
sd_save_core_instance_config -sd_name $sd_name -instance_name axi_to_pti_0
...
sd_connect_pins -sd_name $sd_name -pin_names {"axi_to_pti_0:axi4slave" "fic1ic_0:AXI4mslave0" }

# Trace output connections
sd_connect_pins -sd_name $sd_name -pin_names {"axi_to_pti_0:oTraceClk" "oTraceClk" }
if {$bits_used == $bits_phys} {
	sd_connect_pins -sd_name $sd_name -pin_names {"axi_to_pti_0:oTraceData" "oTraceData" }
} else {
	...
	sd_connect_pins -sd_name $sd_name -pin_names "\"axi_to_pti_0:oTraceData\" \"oTraceData\[[expr $bits_used - 1]:0\]\""
