# Import the axi_to_aurora HDL+ core and its dependencies into the current
# project. After this runs succesfully, you can add the axi_to_aurora core to your
# SmartDesign.
...
import_files -library work -hdl_source hdl_src/axi_to_aurora.vhd
build_design_hierarchy

create_hdl_core -file hdl/axi_to_aurora.vhd -module axi_to_aurora
hdl_core_add_bif -hdl_core_name axi_to_aurora -bif_definition AXI4:AMBA:AMBA4:slave -bif_name axi4slave -signal_map {
	"AWID:AWID"
	"AWADDR:AWADDR"
	"AWLEN:AWLEN"
	"AWSIZE:AWSIZE"
